...
gds_filename = "ind_frame_with_ports.gds"   # geometries
...
settings['margin'] = 20    # distance in microns from GDSII geometry boundary to simulation boundary 

settings['fstart']  = 0e9
settings['fstop']   = 20e9
settings['fstep']   = 0.5e9

settings['refined_cellsize'] = 3  # mesh cell size in conductor region
