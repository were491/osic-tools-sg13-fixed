...
templates = [
    {
        "regex": re.compile(
            rf"^.*sg13_lv_nmos(?=.*w=(?P<w>{NUMBER}))(?=.*l=(?P<l>{NUMBER}))(?=.*(?:ng|nf)=(?P<ng>\d+))(?:(?=.*m=(?P<m>\d+))|)(?!.*rfmode).*$"
        ),
    ...
    {
        "regex": re.compile(
            rf"^.*sg13_lv_pmos(?=.*w=(?P<w>{NUMBER}))(?=.*l=(?P<l>{NUMBER}))(?=.*(?:ng|nf)=(?P<ng>\d+))(?:(?=.*m=(?P<m>\d+))|)(?!.*rfmode).*$"
        ),
        "pcell_library": "SG13_dev",
        "pcell_name": "pmos",
        "params": [
    ...
    {
        "regex": re.compile(
            rf"^.*sg13_hv_nmos(?=.*w=(?P<w>{NUMBER}))(?=.*l=(?P<l>{NUMBER}))(?=.*(?:ng|nf)=(?P<ng>\d+))(?:(?=.*m=(?P<m>\d+))|)(?!.*rfmode).*$"
        ),
        "pcell_library": "SG13_dev",
        "pcell_name": "nmosHV",
        "params": [
    ...
    {
        "regex": re.compile(
            rf"^.*sg13_hv_pmos(?=.*w=(?P<w>{NUMBER}))(?=.*l=(?P<l>{NUMBER}))(?=.*(?:ng|nf)=(?P<ng>\d+))(?:(?=.*m=(?P<m>\d+))|)(?!.*rfmode).*$"
        ),
        "pcell_library": "SG13_dev",
        "pcell_name": "pmosHV",
        "params": [
    ...
    {
        "regex": re.compile(
            rf"^.*sg13_lv_nmos(?=.*w=(?P<w>{NUMBER}))(?=.*l=(?P<l>{NUMBER}))(?=.*(?:ng|nf)=(?P<ng>\d+))(?:(?=.*m=(?P<m>\d+))|)(?=.*rfmode=(?P<rfmode>\d+)).*$"
        ),
        "pcell_library": "SG13_dev",
        "pcell_name": "rfnmos",
        "params": [
    ...
    {
        "regex": re.compile(
            rf"^.*sg13_lv_pmos(?=.*w=(?P<w>{NUMBER}))(?=.*l=(?P<l>{NUMBER}))(?=.*(?:ng|nf)=(?P<ng>\d+))(?:(?=.*m=(?P<m>\d+))|)(?=.*rfmode=(?P<rfmode>\d+)).*$"
        ),
        "pcell_library": "SG13_dev",
        "pcell_name": "rfpmos",
        "params": [
    ...
    {
        "regex": re.compile(
            rf"^.*sg13_hv_nmos(?=.*w=(?P<w>{NUMBER}))(?=.*l=(?P<l>{NUMBER}))(?=.*(?:ng|nf)=(?P<ng>\d+))(?:(?=.*m=(?P<m>\d+))|)(?=.*rfmode=(?P<rfmode>\d+)).*$"
        ),
        "pcell_library": "SG13_dev",
        "pcell_name": "rfnmosHV",
        "params": [
    ...
    {
        "regex": re.compile(
            rf"^.*sg13_hv_pmos(?=.*w=(?P<w>{NUMBER}))(?=.*l=(?P<l>{NUMBER}))(?=.*(?:ng|nf)=(?P<ng>\d+))(?:(?=.*m=(?P<m>\d+))|)(?=.*rfmode=(?P<rfmode>\d+)).*$"
        ),
        "pcell_library": "SG13_dev",
        "pcell_name": "rfpmosHV",
        "params": [
